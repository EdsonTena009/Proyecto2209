...
public class Empleado extends Persona {
    ...
    public Empleado(int numeroEmpleado, String departamento, float sueldo, int horasExtra, String nombre, String apPatern, String apMaterno, int edad, String curp) {
        super(nombre, apPatern, apMaterno, edad, curp);
        this.numeroEmpleado = numeroEmpleado;
        this.departamento = departamento;
        this.sueldo = sueldo;
        this.horasExtra = horasExtra;
